...
--
-- Host: localhost
-- Generation Time: Apr 24, 2026 at 05:51 AM
...
INSERT INTO `companynamelist` (`CompanyInt`, `CompanyName`, `CompanyAddress`, `CompanyType`, `ContactNumber`, `EmailContact`) VALUES
(1, 'Google', 'JalanBoom', 'Technology', '+018293201', 'JamesbONd');
...
--
ALTER TABLE `internship`
  MODIFY `InternshipID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
