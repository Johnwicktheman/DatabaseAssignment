...
--
-- Host: localhost
-- Generation Time: Apr 05, 2026 at 12:38 AM
...
(1, '12345', 'FaysalLecturer67', 1, 'Lecturer'),
...
(1, 1, 'Lecturer', 'This student great at dancing', 2, 3, 4, 5, 6, 7, 8, 9, 10);
...
INSERT INTO `internship` (`InternshipCode`, `CompanyName`, `Role`, `Months_duration`) VALUES
('I3302', 'Google', 'Dancer', 6);
...
INSERT INTO `studentprofile` (`StudentAccountID`, `FirstName`, `LastName`, `ProgrammeCode`, `YearOfStudy`, `InternshipCode`, `AssesorAccountIDLect`, `AssesorAccountIDSuper`) VALUES
(1, 'Micheal', 'Jackson', 'MPU3302', 1, 'I3302', 1, 2);
...
ALTER TABLE `studentprofile`
  ...
  ADD KEY `InternshipCode` (`InternshipCode`);
...
--
ALTER TABLE `assesoraccountlist`
  MODIFY `AssessorAccountID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `studentaccountlist`
  MODIFY `StudentAccountID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `studentprofile`
  ...
  ADD CONSTRAINT `studentprofile_ibfk_5` FOREIGN KEY (`InternshipCode`) REFERENCES `internship` (`InternshipCode`) ON UPDATE CASCADE;
COMMIT;
